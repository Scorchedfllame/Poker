...
import packages.rsa.pem
import packages.rsa.common
import packages.rsa.randnum
import packages.rsa.core
...
class PublicKey(AbstractKey):
    ...
    def _load_pkcs1_der(cls, keyfile: bytes) -> "PublicKey":
        ...
        from packages.pyasn1.codec.der import decoder
        from packages.rsa.asn1 import AsnPubKey
    ...
    def _save_pkcs1_der(self) -> bytes:
        ...
        from packages.pyasn1.codec.der import encoder
        from packages.rsa.asn1 import AsnPubKey
    ...
    def load_pkcs1_openssl_der(cls, keyfile: bytes) -> "PublicKey":
        ...
        from packages.rsa.asn1 import OpenSSLPubKey
        from packages.pyasn1.codec.der import decoder
...
class PrivateKey(AbstractKey):
    ...
    def _save_pkcs1_der(self) -> bytes:
        ...
        from pyasn1.type import univ
        from packages.pyasn1.type import namedtype
        from packages.pyasn1.codec.der import encoder
...
def find_p_q(
    ...
    >>> (p, q) = find_p_q(128)
    >>> from packages.rsa import common
    >>> common.bit_size(p * q)
    256
...
def newkeys(
    ...
    if poolsize > 1:
        from packages.rsa import parallel
