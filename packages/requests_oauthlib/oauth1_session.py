...
from packages.oauthlib.common import urldecode as _urldecode
from packages.oauthlib.oauth1 import SIGNATURE_HMAC, SIGNATURE_RSA, SIGNATURE_TYPE_AUTH_HEADER
import requests
