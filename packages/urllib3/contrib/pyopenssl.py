...
_openssl_versions = {
    packages.urllib3.util.ssl_.PROTOCOL_TLS: OpenSSL.SSL.SSLv23_METHOD,  # type: ignore[attr-defined]
    packages.urllib3.util.ssl_.PROTOCOL_TLS_CLIENT: OpenSSL.SSL.SSLv23_METHOD,  # type: ignore[attr-defined]
...
orig_util_SSLContext = packages.urllib3.util.ssl_.SSLContext
...
def inject_into_urllib3() -> None:
    ...
    packages.urllib3.util.ssl_.SSLContext = PyOpenSSLContext  # type: ignore[assignment]
    util.IS_PYOPENSSL = True
    packages.urllib3.util.ssl_.IS_PYOPENSSL = True
...
def extract_from_urllib3() -> None:
    ...
    packages.urllib3.util.ssl_.SSLContext = orig_util_SSLContext
    util.IS_PYOPENSSL = False
    packages.urllib3.util.ssl_.IS_PYOPENSSL = False
...
class PyOpenSSLContext:
    ...
    def wrap_socket(
        ...
        if server_hostname and not packages.urllib3.util.ssl_.is_ipaddress(server_hostname):
