...
import packages.google.oauth2.credentials

import packages.google_auth_oauthlib.helpers
...
class Flow(object):
    ...
    def from_client_config(cls, client_config, scopes, **kwargs):
        ...
        (
            session,
            client_config,
        ) = packages.google_auth_oauthlib.helpers.session_from_client_config(
    ...
    def credentials(self):
        ...
        """
        return packages.google_auth_oauthlib.helpers.credentials_from_session(
