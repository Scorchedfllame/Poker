...
from packages.oauthlib.common import generate_token
from packages.oauthlib.oauth2 import tokens
from packages.oauthlib.oauth2 import (
    InsecureTransportError, TokenExpiredError,
)
from packages.oauthlib.oauth2.rfc6749.parameters import (
    parse_token_response, prepare_token_request,
    prepare_token_revocation_request,
)
from packages.oauthlib.oauth2.rfc6749.utils import is_secure_transport
