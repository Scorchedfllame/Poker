...
try:
    ...
    from packages.google.longrunning.operations_proto_pb2 import *
    from packages.google.longrunning.operations_proto_pb2 import _OPERATION
    from packages.google.longrunning.operations_proto_pb2 import _OPERATION
    from packages.google.longrunning.operations_proto_pb2 import _GETOPERATIONREQUEST
    from packages.google.longrunning.operations_proto_pb2 import _LISTOPERATIONSREQUEST
    from packages.google.longrunning.operations_proto_pb2 import _LISTOPERATIONSRESPONSE
    from packages.google.longrunning.operations_proto_pb2 import _CANCELOPERATIONREQUEST
    from packages.google.longrunning.operations_proto_pb2 import _DELETEOPERATIONREQUEST
    from packages.google.longrunning.operations_proto_pb2 import _OPERATIONINFO
    from packages.google.longrunning.operations_proto_pb2 import _OPERATIONS
