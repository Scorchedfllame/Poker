...
from packages.google.auth import _default
...
def load_credentials_from_file(filename, scopes=None, quota_project_id=None):
    ...
    if credential_type == _default._AUTHORIZED_USER_TYPE:
        from packages.google.oauth2 import _credentials_async as credentials
        ...
        from packages.google.oauth2 import _service_account_async as service_account
