...
from packages.google.api_core import client_options as client_options_lib  # type: ignore
...
from packages.google.api_core.operations_v1 import pagers
from packages.google.api_core import (
    DEFAULT_CLIENT_INFO,
    OperationsTransport,
)
from packages.google.api_core import OperationsRestTransport
from google.auth import credentials as ga_credentials  # type: ignore
from google.auth.exceptions import MutualTLSChannelError  # type: ignore
from packages.google.auth.transport import mtls
...
class AbstractOperationsClient(metaclass=AbstractOperationsClientMeta):
    ...
    def list_operations(
        ...
        *,
        ...
        retry: OptionalRetry = packages.google.api_core.gapic_v1.method.DEFAULT,
        timeout: Optional[float] = None,
        compression: Optional[grpc.Compression] = packages.google.api_core.gapic_v1.method.DEFAULT,
        ...
        metadata = tuple(metadata or ()) + (
            packages.google.api_core.gapic_v1.routing_header.to_grpc_metadata((("name", request.name),)),
        )
