...
from packages.google.api_core import exceptions as core_exceptions
from packages.google.api_core import page_iterator
from packages.google.api_core import retry as retries
from packages.google.api_core import timeout as timeouts
...
class OperationsClient(object):
    ...
    def __init__(self, channel, client_config=None):
        ...
        self._get_operation = packages.google.api_core.gapic_v1.method.wrap_method(
        ...
        self._list_operations = packages.google.api_core.gapic_v1.method.wrap_method(
        ...
        self._cancel_operation = packages.google.api_core.gapic_v1.method.wrap_method(
        ...
        self._delete_operation = packages.google.api_core.gapic_v1.method.wrap_method(
    ...
    def get_operation(
        self,
        name,
        retry=packages.google.api_core.gapic_v1.method.DEFAULT,
        timeout=packages.google.api_core.gapic_v1.method.DEFAULT,
        compression=packages.google.api_core.gapic_v1.method.DEFAULT,
        metadata=None,
    ):
        ...
        Example:
            >>> from packages.google.api_core import operations_v1
        ...
        metadata.append(packages.google.api_core.gapic_v1.routing_header.to_grpc_metadata({"name": name}))
